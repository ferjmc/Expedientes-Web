  ...
  <div class="app-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        <span class="label__textarea">Motivo de Cierre del Expediente: </span>
        <el-input
...
import { postCerrar } from '@/api/caratulas'
    ...
    submitForm() {
      this.$refs.postForm.validate(valid => {
        if (valid) {
          this.loading = true
          // api call
          postCerrar(this.postForm)
            .then(() => {
              this.$notify({
                title: 'Exito',
                message: 'Expediente cerrado con éxito.',
                type: 'success',
                duration: 2000
              })
              this.$router.push({
